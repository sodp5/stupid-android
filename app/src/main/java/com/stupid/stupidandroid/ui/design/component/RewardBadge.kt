...
fun RewardBadge(
    ...
    OutlinedCard(
        ...
        Row(
            ...
            Icon(imageVector = IconPack.IcRefresh, contentDescription = null)
        }
...
enum class Badge(@DrawableRes val id : Int, val borderColor : Color, val containerColor : Color) {
    Turtle(R.drawable.img_turtle, borderColor = Color(0xFF13C55A), containerColor = Color(0xFFD0F3DE)),
    Tree(R.drawable.img_tree, borderColor = Color(0xFF13C55A), containerColor = Color(0xFFD0F3DE)),
    Dolphin(R.drawable.img_turtle, borderColor = Color(0xFF3CB8F6), containerColor = Color(0xFFDCF4FF)),
    Water(R.drawable.img_water, borderColor = Color(0xFF3CB8F6), containerColor = Color(0xFFDCF4FF)),
